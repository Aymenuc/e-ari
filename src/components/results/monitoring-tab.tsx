...
/**
 * Monitoring tab — the operate-tier surface.
 *
 * Everything here answers a question a single assessment cannot: has it moved,
 * by how much, in which areas, and is the next review on schedule. Trend,
 * drift and pulse used to sit inside the Compliance tab, which meant the
 * time dimension was buried under regulatory mapping and the operate tier
 * looked like the map tier with extra cards appended.
 *
 * Gated on canOperate (rank 2 — autopilot and enterprise), not on a tier name.
 */

import { motion } from 'framer-motion'
import Link from 'next/link'
import { Activity, AlertOctagon, AlertTriangle, ArrowUpRight, Bell, CheckCircle2, ChevronRight, Clock, Loader2, Minus, RefreshCw, RotateCcw, ShieldCheck, TrendingDown, TrendingUp, Zap } from 'lucide-react'
...
export function MonitoringTab(props: ComplianceTabProps) {
  const {
    isPro, assessment, assessmentHistory, historyLoading, driftAnalysis,
    monitoringAlerts, monitoringSchedule, pulseData, pulseLoading, benchmarkData,
