          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-14">
            ...
            <Section id="categories" icon={Database} title="4. Categories of Data Processed">
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                ...
                <li><span className="text-foreground font-medium">Team member roster data:</span> Names, work email addresses, and optional role/department of the customer's personnel, provided by the customer's administrator for AI-literacy training assignment and completion tracking (EU AI Act Article 4). Processed on the customer's instruction; the customer remains controller. Data subjects: customer employees. Retention: until removed by the administrator or account deletion.</li>
                <li><span className="text-foreground font-medium">Vendor contact data:</span> Name and work email of vendor representatives, provided by the customer to deliver AI risk questionnaires. Data subjects: third-party vendor personnel. Retention: until the vendor record is deleted by the customer or account deletion.</li>
