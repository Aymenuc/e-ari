          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-14">
            ...
            <Section id="collection" icon={Database} title="2. Information We Collect">
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                ...
                <li><span className="text-foreground font-medium">Team roster data (AI literacy training):</span> If your organization uses the Article 4 literacy-compliance module, your administrator provides team members' names, work email addresses, and optionally job titles and departments so training can be assigned and completions recorded. Training links are personal, single-purpose, and expire after 30 days; completion records include quiz scores and a cryptographic attestation hash. Team members can request access or deletion of their records via their administrator or by contacting us directly.</li>
                <li><span className="text-foreground font-medium">Vendor contact data:</span> If your organization uses the AI vendor-risk module, you may provide the name and work email address of a contact person at each vendor so we can deliver a risk questionnaire on your behalf. We process this data solely to deliver and record the questionnaire.</li>
                ...
                <li><span className="text-foreground font-medium">Payment information:</span> When you subscribe to the Professional (€49/month), Growth (€149/month), or Enterprise (custom pricing) plan, we collect billing details through our payment processor. E-ARI does not store credit card numbers on our servers; they are handled exclusively by our PCI-compliant payment provider.</li>
                <li><span className="text-foreground font-medium">Sign-in activity:</span> When you use the platform we record the time of your most recent activity, and the approximate location of that activity (country and city) as reported by our hosting provider&apos;s edge network. Your IP address is <span className="text-foreground font-medium">truncated before it is stored</span> &mdash; the final segment is replaced with zero, so we hold 81.2.69.0 rather than the full address. We keep this to answer two operational questions: whether an account is still in use, and whether it is being accessed from somewhere unexpected. We do not build a history: each sign-in overwrites the previous record, and location data is erased 90 days after your last activity. We do not use it for advertising, profiling, or any automated decision about you.</li>
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                <li><span className="text-foreground font-medium">Assessment scores:</span> Calculated pillar scores (0-100), overall readiness score, maturity band classifications (Laggard, Follower, Chaser, Pacesetter), and weighted adjustments generated by the Scoring Agent using deterministic methodology (Scoring v5.3).</li>
            ...
            <Section id="ai-processing" icon={Server} title="4. AI Processing & LLM Usage">
              ...
              <p>
                We use DeepSeek as our primary LLM provider, with Google Gemini for supporting tasks. Data sent through these APIs is not used to train or improve their models. Prompts and completions are not stored by E-ARI beyond the duration of the request. We do not use consumer-facing chat products for processing your assessment data; all processing occurs through provider APIs.
              </p>
            ...
            <Section id="sharing" icon={Users} title="5. Data Sharing & Disclosure">
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                <li><span className="text-foreground font-medium">LLM providers:</span> As described in Section 4, assessment responses and context are sent to DeepSeek, and to Google Gemini for supporting tasks, for agent processing. This data is subject to those providers&apos; API data policies and is not used for model training.</li>
            ...
            <Section id="retention" icon={Database} title="7. Data Retention">
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                ...
                <li><span className="text-foreground font-medium">Sign-in activity:</span> The truncated IP address and approximate location are cleared 90 days after your last activity by an automated daily job. The timestamp of last activity is kept for the life of the account, since &quot;last used in March&quot; carries no location information.</li>
                ...
                <li><span className="text-foreground font-medium">LLM prompts and completions:</span> Not stored by E-ARI beyond the duration of the API request. Retention by our LLM providers is governed by their own API data policies.</li>
              </ul>
            </Section>
            ...
            <Section id="international" icon={Globe} title="11. International Data Transfers">
              <p>
                E-ARI operates globally and your data may be transferred to and processed in countries other than your country of residence. We ensure that all international transfers are protected by appropriate safeguards, including Standard Contractual Clauses approved by the European Commission, adequacy decisions, or other legally recognized transfer mechanisms. When data is transferred to our LLM providers, appropriate safeguards are in place as described in our Data Processing Agreement.
              </p>
              <p>
