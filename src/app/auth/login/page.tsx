      ...
      <CardContent>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-navy-800 px-2 text-muted-foreground font-sans">or continue with</span>
          </div>
        </div>
        <Button
          type="button"
          variant="outline"
          className="w-full bg-navy-700 border-border hover:bg-navy-600 font-sans flex items-center gap-2"
