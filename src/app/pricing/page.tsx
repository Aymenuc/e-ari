...
const PRICING_TIERS = [
  ...
  },
  {
    ...
    period: '/month',
    yearlyPeriod: '/year',
    description: 'Organization-wide AI readiness at scale with dedicated support',
    icon: Shield,
    color: '#d4a853',
...
const FAQ_ITEMS = [
  ...
  {
    question: 'Is the $99/month fee per user or per organization?',
    answer: 'The Professional plan is priced per user at $99/month. Each user gets unlimited assessments and access to all 6 AI agents. For multi-user or organization-wide access, consider our Enterprise plan at $499/month which includes multi-org management, dedicated support, and SSO.',
  },
  {
    question: 'Can I cancel my subscription anytime?',
    answer: 'Yes, absolutely. You can cancel your Professional subscription at any time with no penalties or hidden fees. When you cancel, you will retain access until the end of your current billing period. After that, your account reverts to the Starter plan with 3 assessments and 1 AI Insight summary.',
  },
  {
    question: 'What is the AI Insight summary on the free plan?',
    answer: 'The Starter plan includes 1 AI Insight summary per assessment, giving you a taste of what our AI agents can do. This summary provides a brief strategic overview of your results. The Professional plan unlocks full AI narrative insights with detailed cross-pillar analysis, risk identification, and actionable recommendations.',
  },
  {
    question: 'How does the yearly billing work?',
    answer: 'Yearly billing for Professional is $990/year (saving $198) and Enterprise is $4,990/year (saving $990), both equivalent to 2 months free. You can switch between monthly and yearly billing at any time. When switching to yearly, the new rate applies at your next billing cycle.',
  },
  {
    question: 'Can I upgrade from Professional to Enterprise?',
    answer: 'Absolutely. You can upgrade from Professional ($99/mo) to Enterprise ($499/mo) at any time. Contact our sales team and we will work with you to set up an Enterprise plan that fits your organization\'s needs. Enterprise includes everything in Professional plus SSO, API access, custom branding, multi-org management, and dedicated support.',
  },
  {
