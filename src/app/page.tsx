...
const PRICING_TIERS = [
  {
    ...
    color: '#64748b',
    features: [
      { text: '3 assessments per account', included: true },
      { text: 'Score breakdown by pillar', included: true },
      { text: 'Maturity band classification', included: true },
      { text: '1 AI Insight summary', included: true },
      { text: 'Literacy Agent (basic assessment)', included: true },
      { text: 'Community support', included: true },
      { text: 'E-ARI Certification badge', included: true },
      { text: 'PDF report generation', included: false },
      { text: 'Discovery & Report Agents', included: false },
      { text: 'Regulatory compliance mapping', included: false },
    ],
    cta: 'Start Free',
    href: '/auth/register',
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      { text: 'All 6 AI Agents', included: true },
      ...
      { text: 'Regulatory compliance (EU AI Act, NIST, ISO)', included: true },
      { text: 'E-ARI Certification (Bronze–Gold)', included: true },
    ],
    cta: 'Upgrade to Pro',
    href: '/auth/register',
    highlighted: true,
  },
  {
    ...
    features: [
      ...
      { text: 'E-ARI Platinum Certification', included: true },
      { text: 'Continuous monitoring & drift alerts', included: true },
